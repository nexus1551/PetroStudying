***Сегодня мы изучем как поставим fail2ban на свой сервер debian/ubuntu***
-------------------------------------------------------------
***Что же такое вообще fail2ban?***
Fail2Ban — программа для защиты серверов от брутфорса методом бана айпи адресса через фаерфвол.
-------------------------------------------------------------
